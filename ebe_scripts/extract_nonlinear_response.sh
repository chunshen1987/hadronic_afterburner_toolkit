...
echo "# cen v4_L v4(Psi2) v5_L v5(Psi23) v6(Psi2) v6(Psi3)" > $collision_system\_nonlinear_response_vn_decomposition_ALICE.dat
...
echo "# cen v4_L v4(Psi2) v5_L v5(Psi23) v6(Psi2) v6(Psi3)" > $collision_system\_nonlinear_response_vn_decomposition_CMS.dat
...
echo "# cen v4_L v4(Psi2) v5_L v5(Psi23) v6(Psi2) v6(Psi3)" > $collision_system\_nonlinear_response_vn_decomposition_ATLAS.dat
...
do
        ...
        # print out data
        echo ${centrality[idx]} $v4L $v4Psi2 $v5L $v5Psi23 $v6Psi2 $v6Psi3 >> $collision_system\_nonlinear_response_vn_decomposition_ALICE.dat
        ...
        # print out data
        echo ${centrality[idx]} $v4L $v4Psi2 $v5L $v5Psi23 $v6Psi2 $v6Psi3 >> $collision_system\_nonlinear_response_vn_decomposition_CMS.dat
        ...
        # print out data
        echo ${centrality[idx]} $v4L $v4Psi2 $v5L $v5Psi23 $v6Psi2 $v6Psi3 >> $collision_system\_nonlinear_response_vn_decomposition_ATLAS.dat
